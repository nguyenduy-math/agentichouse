"""Benefits domain specialist agent."""
from __future__ import annotations
from langchain_core.language_models.chat_models import BaseChatModel
from app.agents.base_agent import BaseDomainAgent
from app.prompts.system_prompts import BENEFITS_SYSTEM_PROMPT


class BenefitsAgent(BaseDomainAgent):
    domain_key = "benefits"
    _system_prompt = BENEFITS_SYSTEM_PROMPT
