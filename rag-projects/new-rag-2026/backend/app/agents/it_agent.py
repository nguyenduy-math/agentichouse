"""IT Security domain specialist agent."""
from __future__ import annotations
from langchain_core.language_models.chat_models import BaseChatModel
from app.agents.base_agent import BaseDomainAgent
from app.prompts.system_prompts import IT_SYSTEM_PROMPT


class ITAgent(BaseDomainAgent):
    domain_key = "it"
    _system_prompt = IT_SYSTEM_PROMPT
