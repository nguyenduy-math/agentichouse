"""Procedures (SOP) domain specialist agent."""
from __future__ import annotations
from langchain_core.language_models.chat_models import BaseChatModel
from app.agents.base_agent import BaseDomainAgent
from app.prompts.system_prompts import PROCEDURES_SYSTEM_PROMPT


class ProceduresAgent(BaseDomainAgent):
    domain_key = "procedures"
    _system_prompt = PROCEDURES_SYSTEM_PROMPT
